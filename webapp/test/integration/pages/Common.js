sap.ui.define([
	...
	return Opa5.extend("Products.ZPROD_WORKLIST.test.integration.pages.Common", {
		...
		getMockServer : function () {
			return new Promise(function (success) {
				Opa5.getWindow().sap.ui.require(["Products/ZPROD_WORKLIST/localService/mockserver"], function (mockserver) {
