sap.ui.define([
	"sap/ui/test/Opa5",
	"Products/ZPROD_WORKLIST/localService/mockserver",
	"sap/ui/model/odata/v2/ODataModel"
], function(Opa5, mockserver, ODataModel) {
	"use strict";

	return Opa5.extend("Products.ZPROD_WORKLIST.test.integration.arrangements.Startup", {
